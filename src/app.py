...
os.environ["POPPLER_PATH"] = "/usr/bin" # RE-ADD THIS LINE
...
from pdf2image.exceptions import PopplerNotInstalledError # RE-ADD THIS IMPORT
...
def Automated_Resume_Ranking_System(job_description , pdf_content):
    # ... (rest of the Automated_Resume_Ranking_System function - no changes needed here) ...
    pass # Placeholder
...
if submit:
    if uploaded_file is not None:
        with st.spinner("Processing your resume and job description..."):
            ...
            except PopplerNotInstalledError: # RE-ADD THIS SPECIFIC ERROR CATCH
